module.exports = {
    ...
    "history":["http://104.194.212.9","http://38.103.161.226"],
    "charset":"gbk",
    "deep": true,
    ...
    "selector":{
        ...
        "infoPage":{
            ...
            "author":"sis001",
            "brief":function($){return $('div.mainbox > h1 > a').text()},
            "cover":"http://38.103.161.226/forum/images/green001/logo.png",
            "classes":function($){return $('div.mainbox > h1 > a').text()},
            "isend":false
        },
        "contentPage":{
            "content":function($){return $('div.t_msgfont').eq(0).html()},
            "footer":function($){return $('.footer').length},
            "nextPage":function($){var page = $('.pages_btns > .pages > a.next').attr('href'); return page && page.replace(/&amp;/ig,"&")},
